...
@Singleton
@Component(modules = {RecipeRepositoryModule.class, MainActivityPresenterModule.class, DetailListActivityPresenterModule.class, DetailPagerActivityPresenterModule.class})
